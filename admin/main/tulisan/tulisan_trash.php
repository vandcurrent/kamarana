...
<?php
	   ...
	   $sql	= "select a.*, b.name, c.subcat_name, d.username, e.country_name    from 
                post a, category b, subcategory c, user d, country e where a.deleted = '1'
                 ...
                 if($i%2==0){ 
                    echo"<tr align='center' bgcolor='#e8580f'>";} else { echo"<tr align='center'>";} 
                       echo" <td>".$i."</td>
                        ...
                        <td><a href='?dir=pg&id=$id&kd=del_tulisan_permanen' "; ?> 
                       onClick="return confirm('Yakin akan dihapus permanen ?')" title='Delete' ><i class='fa fa-trash-o fa-fw fa-lg'></i></a></td>
                        <td><?php echo " <a href='?dir=pg&id=$id&kd=res_tulisan' title='Restore Data'><i class='fa fa-undo fa-fw fa-lg'></i></a></td>
                        <td><a href='?dir=thr_dtl&id=$id' title='Detail Tulisan'  ><i class='fa fa-list-alt fa-fw fa-lg'></i></a></td></tr>
                        ";
