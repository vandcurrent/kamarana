...
<div class="col-lg-10 col-sm-10">
        ...
        <strong> List Active Sub Kategori</strong> 
           <hr>
                 ...
                 if($i%2==0){ 
                    echo"<tr align='center' bgcolor='#e8580f'>";} else { echo"<tr align='center'>";} 
                       echo" <td>".$i."</td>
                        ...
                        <td><a href='?dir=pg&id=$id&kd=del_kat' ><i class='fa fa-trash-o fa-fw fa-lg'></i></a></td>
                        <td><a href='?dir=kat_edit&id=$id' ><i class='fa fa-edit fa-fw fa-lg'></i></a></td>
                        ";
